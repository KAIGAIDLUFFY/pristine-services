...
<head>
    ...
    <link rel="stylesheet" href="stikes.css">
        <nav>
            <ul>
                <li><a href="index.html">Home</a></li>
                <li><a href="about.html">About Us</a></li>
                <li><a href="emp.php">Tasks</a></li>
...
// Update booking group if form is submitted
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['service']) && isset($_POST['group_id'])) {
    $service = $conn->real_escape_string($_POST['service']);
    $group_id = $conn->real_escape_string($_POST['group_id']);
    $update_sql = "UPDATE `booking payment` SET `group_id` = '$group_id' WHERE `Service` = '$service'";
...
$sql = "SELECT Name, Email, Phone, Address, Service, Price, Date, group_id FROM `booking payment` ORDER BY Name DESC";
