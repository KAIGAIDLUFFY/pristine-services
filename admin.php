...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['service']) && isset($_POST['status'])) {
    ...
    $update_sql = "UPDATE `booking payment` SET `Status` = '$status' WHERE `Service` = '$service'";
...
$sql = "SELECT Name, Email, Phone, Address, Service, Price, Date, Status FROM `booking payment` ORDER BY Name DESC";
